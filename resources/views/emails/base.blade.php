...
<table class="body" style="border-spacing: 0;border-collapse: collapse;vertical-align: top;height: 100%;width: 100%;table-layout: fixed" cellpadding="0" cellspacing="0" width="100%" border="0">
    <tbody><tr style="vertical-align: top">
        <td class="center" style="word-break: break-word;-webkit-hyphens: auto;-moz-hyphens: auto;hyphens: auto;border-collapse: collapse !important;vertical-align: top;text-align: center;background-color: #FFFFFF" align="center" valign="top">
            ...
            @if(isset($logoPath)) {{--Can't add logo to password resest email so leave it out--}}
                                                                ...
                                                                <table style="border-spacing: 0;border-collapse: collapse;vertical-align: top" cellpadding="0" cellspacing="0" width="100%">
                                                                    <tbody><tr style="vertical-align: top">
                                                                        <td style="word-break: break-word;-webkit-hyphens: auto;-moz-hyphens: auto;hyphens: auto;border-collapse: collapse !important;vertical-align: top;padding-top: 10px;padding-right: 10px;padding-bottom: 10px;padding-left: 10px">
                                                                            <div style="color:#333333;line-height:120%;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;">
                                                                                <div style="font-size: 14px; line-height: 16px;color: #333333;font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif;text-align: left;line-height: 17px">
                                                                                    <span style="font-size:20px; line-height:24px;font-family:'lucida sans unicode', 'lucida grande', sans-serifpx;">
                                                                                        @yield('body1')
                                                                                        <br>
                                                                                        @yield('body2')
                                                                                </span>
                                                                                ...
                                                                                <tbody><tr style="vertical-align: top">
                                                                                    <td class="button-container" style="word-break: break-word;-webkit-hyphens: auto;-moz-hyphens: auto;hyphens: auto;border-collapse: collapse !important;vertical-align: top" align="center">
                                                                                        <table style="border-spacing: 0;border-collapse: collapse;vertical-align: top" border="0" cellspacing="0" cellpadding="0" align="center">
                                                                                            ...
                                                                                            <tbody><tr style="vertical-align: top">
                                                                                                <td class="button" style="text-decoration: none;word-break: break-word;-webkit-hyphens: auto;-moz-hyphens: auto;hyphens: auto;border-collapse: collapse !important;vertical-align: middle;text-align: center;-webkit-border-radius: 3px;-moz-border-radius: 3px;border-radius: 3px;height: 62px" bgcolor="#42b3ff" width="200px" valign="middle">

                                                                                                    <a style="text-decoration: none;display: inline-block;-webkit-text-size-adjust: none;text-align: center;line-height: 100%;padding-top: 10px;                         padding-right: 25px;                        padding-bottom: 10px;                        padding-left: 25px;                        text-align:center;                        font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif;-webkit-border-radius: 3px;-moz-border-radius: 3px;border-radius: 3px;border-top: 0px solid transparent;border-right: 0px solid transparent;border-bottom: 0px solid transparent;border-left: 0px solid transparent;color: #FEFEFE" href="@yield('button-link')" target="_blank">

                                                                                                        <!--[if mso]>&nbsp;<![endif]-->
                                                                                                        <p style="text-decoration: none;margin: 0;font-family: inherit;font-size: 16px;line-height: 32px" data-mce-style="font-family: inherit; font-size: 16px; line-height: 32px;"><strong style="color: #ffffff; text-decoration: none;">@yield('button-text')</strong></p>
                                                                                                        <!--[if mso]>&nbsp;<![endif]-->
                                                                                                    </a>
                                                                                                                        ...
                                                                                                                        <tbody><tr style="vertical-align: top">
                                                                                                                            <td style="word-break: break-word;-webkit-hyphens: auto;-moz-hyphens: auto;hyphens: auto;border-collapse: collapse !important;vertical-align: top;padding-top: 10px;padding-right: 0px;padding-bottom: 10px;padding-left: 0px">
                                                                                                                                <div style="color:#333333;line-height:120%;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;">
                                                                                                                                    <div style="font-size: 14px; line-height: 16px; text-align: center;color: #333333;font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif;line-height: 17px">
                                                                                        <span style="font-size:20px; line-height:43px;"><strong>
                                                                                                <a href="https://statspro.io/?utm_source=email&utm_medium=banner">
                                                                                                    <img src="<?php echo $message->embed("https://roastmygame.com/images/stats-pro-banner.jpg"); ?>" alt="{{strtoupper(Config::get('app.name'))}}">
                                                                                                </a>
                                                                                                {{--<span style="line-height: 43px; font-size: 36px;" data-mce-style="line-height: 43px; font-size: 36px;">{{strtoupper(Config::get('app.name'))}}</span>--}}
                                                                                            </strong></span>
                                                                                                                                    </div>
                                                                    ...
                                                                    <tbody><tr style="vertical-align: top">
                                                                        <td style="word-break: break-word;-webkit-hyphens: auto;-moz-hyphens: auto;hyphens: auto;border-collapse: collapse !important;vertical-align: top;padding-top: 10px;padding-right: 10px;padding-bottom: 10px;padding-left: 10px">
                                                                            <div style="color:#717A83;line-height:120%;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;">
                                                                                <div style="font-size: 14px; line-height: 16px;color: #717A83;font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif;text-align: left;line-height: 17px"><p style="margin: 0;font-size: 14px;line-height: 17px">@yield('footer-text')</p></div><div style="font-size: 14px; line-height: 16px;font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif;text-align: left;line-height: 17px; color: #929DB0;"><a style="color: #929DB0;" href="@yield('footer-link')">@yield('footer-link-text')</a> <br><br></div>
                                                                                <div style="font-size: 14px; line-height: 16px;color: #717A83;font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif;text-align: left;line-height: 17px"><p style="margin: 0;font-size: 14px;line-height: 17px">To unsubscribe from these emails, visit your </p></div><div style="font-size: 14px; line-height: 16px;font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif;text-align: left;line-height: 17px; color: #929DB0;"><a style="color: #929DB0;" href="{{secure_url('/settings')}}">settings</a>. <br></div>
                                                                            </div>
                                                                        </td>
                                                                    </tr>
                                                                    </tbody></table>
