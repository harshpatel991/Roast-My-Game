...
@section('page-title')
    Terms and Conditions - {{Config::get('app.name')}}
@endsection
        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                <div class="content-background">
                    <h1 class="form-title">Web Site Terms and Conditions of Use</h1>

                    <h3 class="form-title">1. Terms</h3>
                    <p>
                    ...
                    <h3 class="form-title">2. Use License</h3>
                    <ol type="a">
                        <li>
                    ...
                    <h3 class="form-title">3. Disclaimer</h3>
                    <ol type="a">
                        <li>
                    ...
                    <h3 class="form-title">4. Limitations</h3>
                    <p>
                    ...
                    <h3 class="form-title">5. Revisions and Errata</h3>
                    <p>
                    ...
                    <h3 class="form-title">6. Links</h3>
                    <p>
                    ...
                    <h3 class="form-title">7. Content</h3>
                    <p>
                    ...
                    <h3 class="form-title">8. Site Terms of Use Modifications</h3>
                    <p>
                    ...
                    <h3 class="form-title">9. Governing Law</h3>
                    <p>
