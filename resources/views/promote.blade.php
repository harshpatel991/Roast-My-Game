        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                <div class="content-background">
                    ...
                    <div class="row">
                        <div class="col-sm-10">
                            <input class="form-control placeholder-dark" type="text" value="{{$helpMessage = Utils::random_roast_message()}}" readonly="readonly">
                        </div>
                        <div class="col-sm-2">
                    ...
                    <a href="/game/{{$game->slug}}"><img src="https://s3-us-west-2.amazonaws.com/rmg-upload/public/share_button.jpg" class="center-block play-button-text-content"></a>
                    <div class="row">
                        <div class="col-sm-10">
                    ...
                    <div class="row">
                        <div class="col-sm-10">
                            <input id="forum-contents" class="form-control placeholder-dark" type="text" value="{{"[URL='". url('/game/'.$game->slug) ."'][IMG]https://s3-us-west-2.amazonaws.com/rmg-upload/public/share_button.jpg[/IMG] [/URL]"}}" readonly="readonly">
                        </div>
                        <div class="col-sm-2">
