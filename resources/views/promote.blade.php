        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                <div class="content-background">
                    ...
                    <a href="{{ secure_url('/game/'.$game->slug) }}"><img width="150px" height="45px" src="https://s3-us-west-2.amazonaws.com/rmg-upload/public/share_button.png" class="center-block"></a>
                    <br>
                    <div class="row">
                        <div class="col-sm-10">
                            <input id="website-contents" class="form-control placeholder-dark" type="text" value="{{'<a href="'. secure_url('/game/'.$game->slug) .'"><img width="150px" height="45px" src="https://s3-us-west-2.amazonaws.com/rmg-upload/public/share_button.png"></a>'}}" readonly="readonly">
                        </div>
                        <div class="col-sm-2">
                    ...
                    <div class="row">
                        <div class="col-sm-10">
                            <input id="forum-contents" class="form-control placeholder-dark" type="text" value="{{"[URL='". secure_url('/game/'.$game->slug) ."'][IMG]https://s3-us-west-2.amazonaws.com/rmg-upload/public/share_button.png[/IMG] [/URL]"}}" readonly="readonly">
                        </div>
                        <div class="col-sm-2">
