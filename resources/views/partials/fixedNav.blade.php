                        ...
                        @else
                            ...
                            <li class="dropdown text-center" style="margin-left: 10px;">
                                ...
                                <ul class="dropdown-menu" style="margin-top:0px;">
                                    ...
                                    <li><a href="/settings" class="category" id="settings-button"><span class="icon-cog"></span>Settings</a></li>
                                    <li><a href="/auth/logout" class="category" id="logout-button"><span class="icon-logout"></span>Logout</a></li>
                                </ul>
                            </li>
