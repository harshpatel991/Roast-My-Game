...
backupremotedb() {
  ...
  mysqldump --user=***REMOVED*** -p$dbpassword --host=rmg2.cwqtmomh10su.us-west-2.rds.amazonaws.com --protocol=tcp --port=3306 --default-character-set=utf8 "rmg" -r "./prod-db-backups/backup$dt_now.sql"
