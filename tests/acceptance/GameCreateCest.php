...
class GameCreateCest
{
    ...
    public function testAddMinimumGameValues(\AcceptanceTester $I)
    {
        ...
        $I->see('VERSION 3.4.5');
        $I->dontSee('BETA');
        $I->dontSeeElement('#download-dropdown');
        $I->dontSee('Links');
        ...
        //verify email
        $I->seeInLastEmailTo("roastmygame@gmail.com", "Your Game Has Been Added");
        $I->seeInLastEmailTo("roastmygame@gmail.com", "https://clickr.app/game/test-minimal-title");
    ...
    public function testAddAllGameValues(\AcceptanceTester $I)
    {
        ...
        $I->fillField('link_social_kickstarter', 'http://kickstarter.com');
        ...
        $I->seeInSource('<a rel="nofollow" target="_blank" href="http://kickstarter.com">');
        ...
        $I->seeInLastEmailTo("roastmygame@gmail.com", "Your Game Has Been Added");
        $I->seeInLastEmailTo("roastmygame@gmail.com", "https://clickr.app/game/test-full-title");
        $I->seeInLastEmailTo("user1@gmail.com", "Your Game Has Been Added");
